...
const DonutChartLegend = (): JSX.Element => {
    ...
    return (
        <section id='DonutChartLegend' className='DonutChartLegend'>
            <Box sx={styles}>
                <p className='DonutChartLegend__description'>Principal &amp; interest</p>
                <p className='DonutChartLegend__amount'>${principalAndInterest}</p>
            </Box>
            <Box sx={styles}>
                <p className='DonutChartLegend__description'>Property tax</p>
                <p className='DonutChartLegend__amount'>${propertyTax}</p>
            </Box>
            <Box sx={styles}>
                <p className='DonutChartLegend__description'>Homeowner's insurance</p>
                <p className='DonutChartLegend__amount'>${homeownersInsurance}</p>
            </Box>
            <Box sx={styles}>
                <p className='DonutChartLegend__description'>HOA fees</p>
                <p className='DonutChartLegend__amount'>${HOAFees}</p>
            </Box>
            <Box sx={styles}>
                <p className='DonutChartLegend__description'>Other costs</p>
                <p className='DonutChartLegend__amount'>${otherCosts}</p>
            </Box>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <p className='DonutChartLegend__description'><b>Total monthly payment</b></p>
